...
#collabWorkspace *{max-width:100%;box-sizing:border-box}.cw-wrap{padding:26px;max-height:min(90vh,calc(100dvh - 24px));overflow:auto;overscroll-behavior:contain}.cw-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.cw-head h2{margin:4px 0 6px;font-size:clamp(25px,5vw,38px)}
...
@media(max-width:780px){#collabWorkspace{width:calc(100% - 20px);max-height:calc(100vh - 20px);max-height:calc(100dvh - 20px)}.cw-wrap{max-height:calc(100vh - 20px);max-height:calc(100dvh - 20px)}}
@media(max-width:520px){#collabWorkspace{width:calc(100% - 16px);max-height:calc(100vh - 16px);max-height:calc(100dvh - 16px);border-radius:20px}.cw-wrap{padding:18px;max-height:calc(100vh - 16px);max-height:calc(100dvh - 16px)}.cw-head{gap:10px}.cw-head h2{font-size:28px}.cw-entry{grid-template-columns:1fr}.cw-entry-card{padding:16px}.cw-entry-card h3{font-size:20px}.cw-actions{display:grid}.cw-actions button{width:100%}.cw-actions .leave{order:-1}.cw-code{font-size:28px}.cw-log{height:150px}.cw-compose{flex-direction:column}.cw-send{width:100%}.cw-review-actions{display:grid}}
`;
d.head.append(css);
