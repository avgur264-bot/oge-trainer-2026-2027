...
#collabWorkspace *{max-width:100%;box-sizing:border-box}.cw-actions[hidden],.cw-log[hidden],.cw-compose[hidden],.cw-entry[hidden],.cw-review[hidden],#cwCodeBox[hidden]{display:none!important}.cw-wrap{padding:26px;max-height:min(90vh,calc(100dvh - 24px));overflow:auto;overscroll-behavior:contain}.cw-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.cw-head h2{margin:4px 0 6px;font-size:clamp(25px,5vw,38px)}
